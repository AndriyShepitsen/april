...
<h1>Deed in Lieu</h1> 
<hr/>
<p>A deed in lieu of foreclosure is a deed instrument in which a mortgagor (i.e. the borrower) conveys all interest in a real property to the mortgagee (i.e. the lender) to satisfy a loan that is in default and avoid foreclosure proceedings.</p>
...
<p>If there are any junior liens a deed in lieu is a less attractive option for the lender. The lender will likely not want to assume the liability of the junior liens from the property owner, and accordingly, the lender will prefer to foreclose in order to clean the title.</p>
